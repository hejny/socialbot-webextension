...
!(function(e, t) {
    ...
    var f = '3.4.1',
        ...
        p = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;
    function d(e) {
        var t = TODO: !!e && 'length' in e && e.length,
            n = w(e);
    ...
    var h = (function(n) {
        ...
        ((b = se.selectors = {
            ...
            pseudos: {
                ...
                focus: function(e) {
                    return (
                        e === C.activeElement && (!C.hasFocus || C.hasFocus()) && TODO: !!(e.type || e.href || ~e.tabIndex)
                    );
                },
                enabled: ge(!1),
                disabled: ge(!0),
                checked: function(e) {
                    var t = e.nodeName.toLowerCase();
                    return ('input' === t && TODO: !!e.checked) || ('option' === t && TODO: !!e.selected);
                },
                selected: function(e) {
    ...
    (k.filter = function(e, t, n) {
        ...
        k.fn.extend({
            ...
            is: function(e) {
                return TODO: !!j(this, 'string' == typeof e && N.test(e) ? k(e) : e || [], !1).length;
            },
        });
    var q,
        L = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    (me = E.createDocumentFragment().appendChild(E.createElement('div'))),
        ...
        (y.noCloneChecked = TODO: !!me.cloneNode(!0).lastChild.defaultValue);
    var Te = /^key/,
    ...
    (Ft.href = Et.href),
        ...
        (k.expr.pseudos.visible = function(e) {
            return TODO: !!(e.offsetWidth || e.offsetHeight || e.getClientRects().length);
        }),
    ...
    (y.cors = TODO: !!Xt && 'withCredentials' in Xt),
        (y.ajax = Xt = TODO: !!Xt),
